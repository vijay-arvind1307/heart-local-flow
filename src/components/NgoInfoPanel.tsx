      ...
      {isVisible && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-[2001] max-h-[85vh] overflow-hidden"
          >
            <Card className="bg-gradient-card border-t-4 border-t-accent-red rounded-t-3xl rounded-b-none shadow-elegant h-full">
              {/* Handle */}
              <div className="w-12 h-1.5 bg-text-gray rounded-full mx-auto mt-3 opacity-50 flex-shrink-0"></div>
              
              {/* Scrollable Content Container */}
              <div className="overflow-y-auto max-h-[calc(85vh-40px)] pb-4">
                <CardContent className="p-6 pb-8">
                  ...
                  <div className="flex items-start justify-between mb-6">
                    ...
                    <Button
                      ...
                      size="icon"
                      onClick={onClose}
                      className="text-text-gray hover:text-off-white hover:bg-light-dark-blue ml-4 flex-shrink-0"
                    >
                      <X className="w-5 h-5" />
                    </Button>
                  </div>
