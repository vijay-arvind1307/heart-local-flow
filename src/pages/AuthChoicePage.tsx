    ...
    <div className="min-h-screen bg-dark-blue flex items-center justify-center p-4">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        <motion.h1 
          ...
          className="text-4xl md:text-5xl font-bold text-off-white mb-12"
        >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <motion.div
                ...
                whileHover={{ 
                  scale: 1.05,
                  boxShadow: "0 20px 40px rgba(255, 76, 76, 0.3)"
                }}
                className="bg-light-dark-blue rounded-2xl p-8 cursor-pointer border border-border hover:border-accent-red/50 transition-all duration-300 shadow-card"
                onClick={handleStudentChoice}
              >
                <div className="flex flex-col items-center space-y-4">
                  <div className="w-20 h-20 bg-gradient-to-br from-accent-red to-accent-red-hover rounded-full flex items-center justify-center">
                    <GraduationCap className="w-10 h-10 text-white" />
                  </div>
                  <h2 className="text-2xl font-semibold text-off-white">I'm a Student</h2>
            ...
            <TooltipTrigger asChild>
              ...
              >
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <h2 className="text-2xl font-semibold text-off-white">I'm an NGO</h2>
                  <p className="text-text-gray text-center">
        ...
        >
          <button
            onClick={() => navigate('/')}
            className="text-text-gray hover:text-off-white transition-colors duration-300"
          >
            ← Back to Home
          </button>
        </motion.div>
